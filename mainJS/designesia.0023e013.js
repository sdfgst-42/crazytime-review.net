...
(function($) {
    ...
    var header = $("header");
     ...
     function load_magnificPopup() {
         ...
         $('.image-popup-vertical-fit').magnificPopup({
             ...
             mainClass: 'mfp-img-mobile_92f301c8a8a9efdb',
             image: {
                 verticalFit: true
             }
         });
     ...
     function init_resize() {
         ...
         header.removeClass('logo-smaller_c65e3f66e4758f70');
     ...
     function load_owl() {
        ...
        jQuery("#slider-carousel").owlCarousel({
                ...
                thumbs: true,
                thumbImage: true,
                thumbContainerClass: 'owl-thumbs_e29d16b45167b0bb',
                thumbItemClass: 'owl-thumb-item_7e64676073dbc320'
            });
     ...
     function sequence() {
         ...
         var count = sq.length;
		 sq.addClass("fadeIn");
         sq.find("img").addClass("scaleIn_998369315e0d3feb");
     ...
     function sequence_a() {
         ...
         var count = sq.length;
         sq.addClass("fadeInUp_d043e766db38fb98");
         for (var i = 0; i <= count; i++) {
         ...
         function scrolling() {
             ...
             if (mq.matches) {
                 ...
                 if (distanceY > shrinkOn) {
                     ...
                     /* restore transparent class if it was stripped on mobile */
                     if (!header.hasClass('transparent')) {
                         header.addClass('transparent');
                     }
                 }
             } else {
                 /* mobile — transparent at page top, solid (smaller) when scrolled */
                 if (!jQuery("header").hasClass("menu-open")) {
                     var distanceY = window.pageYOffset || document.documentElement.scrollTop;
                     var mobileHeader = jQuery("header");
                     if (distanceY > 10) {
                         mobileHeader.addClass("smaller");
                         mobileHeader.removeClass("transparent");
                     } else {
                         mobileHeader.removeClass("smaller");
     ...
     jQuery("#dark-mode").on("click", function() {
        if(jQuery('body').hasClass('dark-scheme_74a1724d6193afa0')){
	 ...
	 function grid_gallery() {
            jQuery('.grid-item').each(function () {
                ...
                if (gi.hasClass('large_31cfa3baf9030743')) {
    ...
    function de_share(){
      ...
      * --------------------------------------------------*/
     $(function(){
        $('#de-loader ').prepend($('<div class="lds-roller_eae500cd45192dd9"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div>'));
         'use strict';
         f_rtl();
         load_magnificPopup();
		 grid_gallery();
